## Header `<list>` implementation status

[Reference](https://en.cppreference.com/w/cpp/header/list)  
[Implementation](../include/lsd/list.h)
...
| lsd::swap(lsd::list)                           | ![][legacy]          | ![][notyet]                       |
| erase(lsd::list) <br/>erase_if(lsd::list)      | ![][cpp20]           | ![][notyet]                       |
| **Range access**                             |                      |                                   |
