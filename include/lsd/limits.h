...
#  */
#
# ifndef LSD_LIMITS_H_
# define LSD_LIMITS_H_
#
# include <cfloat>
# include <climits>
# include <cmath>
...
# include <limits>
#
# include "lsd/__deprecated.h"
# include "lsd/type_traits.h"

#define LSD_DEPRECATED_DENORM_CXX23 LSD_DEPRECATED_AFTER_CXX_23("")
#define LSD_DEPRECATED_DENORM_LOLSD_CXX23 LSD_DEPRECATED_AFTER_CXX_23("")

#if defined(INFINITY)
#define LSD_DEFINED_INFINITY 1
#else
#define LSD_DEFINED_INFINITY 0
#endif
...
class numeric_limits {
 public:
  ...
  LSD_DEPRECATED_DENORM_CXX23 static constexpr float_denorm_style has_denorm = float_denorm_style::denorm_absent;
  LSD_DEPRECATED_DENORM_LOLSD_CXX23 static constexpr bool has_denorm_loss = false;
...
class numeric_limits<float> {
 public:
  ...
  static constexpr bool is_integer = false;
  static constexpr bool is_exact = false;
  static constexpr bool has_infinity = LSD_DEFINED_INFINITY;
  ...
  LSD_DEPRECATED_DENORM_CXX23 static constexpr float_denorm_style has_denorm = float_denorm_style::denorm_present;
  LSD_DEPRECATED_DENORM_LOLSD_CXX23 static constexpr bool has_denorm_loss = true;
