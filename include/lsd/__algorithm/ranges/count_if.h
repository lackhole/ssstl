...
#ifndef LSD_ALGORITHM_RANGES_COUNT_IF_H_
#define LSD_ALGORITHM_RANGES_COUNT_IF_H_
...
LSD_INLINE_VARIABLE constexpr detail::count_if_niebloid count_if{};

} // namespace ranges
} // namespace lsd

#endif // LSD_ALGORITHM_RANGES_COUNT_IF_H_
