...
#ifndef LSD_ALGORITHM_RANGES_POP_HEAP_HPP_
#define LSD_ALGORITHM_RANGES_POP_HEAP_HPP_
...
LSD_INLINE_OR_STATIC constexpr detail::pop_heap_niebloid pop_heap{};

} // namespace ranges
} // namespace lsd

#endif // LSD_ALGORITHM_RANGES_POP_HEAP_HPP_
