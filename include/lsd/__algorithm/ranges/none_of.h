...
#ifndef LSD_ALGORITHM_RANGES_NONE_OF_H_
#define LSD_ALGORITHM_RANGES_NONE_OF_H_
...
LSD_INLINE_VARIABLE constexpr detail::none_of_niebloid none_of{};

} // namespace ranges
} // namespace lsd

#endif // LSD_ALGORITHM_RANGES_NONE_OF_H_
