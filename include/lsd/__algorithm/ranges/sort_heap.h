...
#ifndef LSD_ALGORITHM_RANGES_SORT_HEAP_H_
#define LSD_ALGORITHM_RANGES_SORT_HEAP_H_
...
LSD_INLINE_VARIABLE constexpr detail::sort_heap_niebloid sort_heap{};

} // namespace ranges
} // namespace lsd

#endif // LSD_ALGORITHM_RANGES_SORT_HEAP_H_
