...
#ifndef LSD_ALGORITHM_RANGES_ANY_OF_HPP
#define LSD_ALGORITHM_RANGES_ANY_OF_HPP
...
LSD_INLINE_OR_STATIC constexpr detail::any_of_niebloid any_of{};

} // namespace ranges
} // namespace lsd

#endif // LSD_ALGORITHM_RANGES_ANY_OF_HPP
