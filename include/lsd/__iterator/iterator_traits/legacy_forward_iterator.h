...
#ifndef LSD_ITERATOR_ITERATOR_TRAITS_LEGACY_FORWARD_ITERATOR_H_
#define LSD_ITERATOR_ITERATOR_TRAITS_LEGACY_FORWARD_ITERATOR_H_
...
#endif // LSD_ITERATOR_ITERATOR_TRAITS_LEGACY_FORWARD_ITERATOR_H_
