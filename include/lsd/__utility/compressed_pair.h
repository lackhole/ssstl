...
template<typename T, typename U> struct tuple_element<0, lsd::compressed_pair<T, U>> { using type = T; };
template<typename T, typename U> struct tuple_element<1, lsd::compressed_pair<T, U>> { using type = U; };
template<typename T, typename U> struct tuple_size<lsd::compressed_pair<T, U>> : std::integral_constant<std::size_t, 2> {};

template<std::size_t I, typename T, typename U>
constexpr tuple_element_t<I, lsd::compressed_pair<T, U>>& get(lsd::compressed_pair<T, U>& p) noexcept {
  return lsd::detail::compressed_pair_getter<I>::get(p);
}
template<std::size_t I, typename T, typename U>
constexpr const tuple_element_t<I, lsd::compressed_pair<T, U>>& get(const lsd::compressed_pair<T, U>& p) noexcept {
  return lsd::detail::compressed_pair_getter<I>::get(p);
}
template<std::size_t I, typename T, typename U>
constexpr tuple_element_t<I, lsd::compressed_pair<T, U>>&& get(lsd::compressed_pair<T, U>&& p) noexcept {
  return lsd::detail::compressed_pair_getter<I>::get(std::move(p));
}
template<std::size_t I, typename T, typename U>
constexpr const tuple_element_t<I, lsd::compressed_pair<T, U>>&& get(const lsd::compressed_pair<T, U>&& p) noexcept {
  return lsd::detail::compressed_pair_getter<I>::get(std::move(p));
...
template<typename T, typename U> constexpr T& get(lsd::compressed_pair<T, U>& p) noexcept { return p.first(); }
template<typename T, typename U> constexpr const T& get(const lsd::compressed_pair<T, U>& p) noexcept { return p.first(); }
template<typename T, typename U> constexpr T&& get(lsd::compressed_pair<T, U>&& p) noexcept { return std::move(p.first()); }
template<typename T, typename U> constexpr const T&& get(const lsd::compressed_pair<T, U>&& p) noexcept { return std::move(p.first()); }

template<typename T, typename U> constexpr T& get(lsd::compressed_pair<U, T>& p) noexcept { return p.second(); }
template<typename T, typename U> constexpr const T& get(const lsd::compressed_pair<U, T>& p) noexcept { return p.second(); }
template<typename T, typename U> constexpr T&& get(lsd::compressed_pair<U, T>&& p) noexcept { return std::move(p.second()); }
template<typename T, typename U> constexpr const T&& get(const lsd::compressed_pair<U, T>&& p) noexcept { return std::move(p.second()); }
