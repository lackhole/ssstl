...
#include "lsd/__type_traits/is_character.h"
...
constexpr bool cmp_equal(T t, U u) noexcept {
  ...
  return lsd::detail::cmp_equal_impl(t, u, std::is_signed<T>{}, std::is_signed<U>{});
}

template<typename T, typename U>
constexpr bool cmp_not_equal(T t, U u) noexcept {
  return !lsd::cmp_equal(t, u);
}

template<typename T, typename U>
constexpr bool cmp_less(T t, U u) noexcept {
  static_assert(detail::cmp_requires<T, U>::value, "Both values must be integral, not a character type and not bool");
  return lsd::detail::cmp_less_impl(t, u, std::is_signed<T>{}, std::is_signed<U>{});
}

template<typename T, typename U>
constexpr bool cmp_greater(T t, U u) noexcept {
  return lsd::cmp_less(u, t);
}
