...
# include "lsd/__memory/allocator_arg.h"
# include "lsd/__memory/uses_allocator.h"
...
template<typename T>
struct is_copy_list_initializable<T, void_t<decltype(lsd::declval<T&>() = {})>> : true_type {};
...
struct tuple_leaf {
  ...
  template<typename U>
  constexpr tuple_leaf(U&& arg) : element(lsd::forward<U>(arg)) {}
  ...
  constexpr tuple_leaf(allocator_arg_t, const Alloc& alloc, U&&... arg)
      : element(allocator_arg_t{}, alloc, lsd::forward<U>(arg)...) {}
...
struct tuple_impl<index_sequence<I...>, Types...> : public tuple_leaf<I, Types>... {
  ...
  constexpr tuple_impl(UTypes&&... args) : tuple_leaf<I, Types>(lsd::forward<UTypes>(args))... {}

  template<typename Alloc, typename... UTypes>
  constexpr tuple_impl(allocator_arg_t, const Alloc& alloc, UTypes&&... args)
      : tuple_leaf<I, Types>(allocator_arg_t{}, alloc, lsd::forward<UTypes>(args))... {}
...
LSD_CONSTEXPR_AFTER_14 void tuple_element_wise_copy(Dst& dst, const Src& src, index_sequence<I...>);

template<typename Dst, typename Src, size_t... I>
LSD_CONSTEXPR_AFTER_14 void tuple_element_wise_forward(Dst& dst, Src&& src, index_sequence<I...>);
...
struct tuple_index_impl<I, T, tuple<T, Rest...>> {
  ...
  static_assert(tuple_index_impl<I + 1, T, tuple<Rest...>>::found == false,
    "lsd::get(lsd::tuple) : Duplicated type T in lsd::tuple");
};
...
struct tuple_index {
  ...
  static_assert(found, "lsd::get(lsd::tuple) : No type T in lsd::tuple");
};
...
class tuple {
  ...
  constexpr tuple(tuple_tag_unpack_tuple_t, index_sequence<I...>, Tuple&& other)
    : base(lsd::get<I>(other)...) {}

  template<typename Tuple>
  constexpr tuple(tuple_tag_unpack_tuple_t, Tuple&& other)
    : tuple(tuple_tag_unpack_tuple_t{}, make_index_sequence<sizeof...(Types)>{}, lsd::forward<Tuple>(other)) {}
  ...
  constexpr tuple(tuple_tag_unpack_tuple_t, index_sequence<I...>, const Alloc& alloc, Tuple&& other)
    : base(allocator_arg_t{}, alloc, lsd::get<I>(other)...) {}

  template<typename Alloc, typename Tuple>
  constexpr tuple(tuple_tag_unpack_tuple_t, const Alloc& alloc, Tuple&& other)
    : tuple(tuple_tag_unpack_tuple_t{}, make_index_sequence<sizeof...(Types)>{}, alloc, lsd::forward<Tuple>(other)) {}
 ...
 public:
  ...
  template<typename... UTypes,
    enable_if_t<
      ...
      >::value,
    int> = 0>
  constexpr tuple(UTypes&&... args) : base(lsd::forward<UTypes>(args)...) {}
  ...
  template<typename... UTypes,
    enable_if_t<
      ...
      >::value,
    int> = 0>
  constexpr explicit tuple(UTypes&&... args) : base(lsd::forward<UTypes>(args)...) {}
  ...
  constexpr tuple(allocator_arg_t, const Alloc& alloc, UTypes&&... args)
      : base(allocator_arg_t{}, alloc, lsd::forward<UTypes>(args)...) {}
  ...
  template<typename... UTypes,
    enable_if_t<
      ...
      >::value,
    int> = 0>
  constexpr tuple(tuple<UTypes...>&& other) : tuple(tuple_tag_unpack_tuple_t{}, lsd::move(other)) {}
  ...
  template<typename... UTypes,
    enable_if_t<
      ...
      >::value,
    int> = 0>
  constexpr explicit tuple(tuple<UTypes...>&& other) : tuple(tuple_tag_unpack_tuple_t{}, lsd::move(other)) {}
  ...
  constexpr tuple(allocator_arg_t, const Alloc& alloc, tuple<UTypes...>&& other)
      : tuple(tuple_tag_unpack_tuple_t{}, alloc, lsd::move(other)) {}
  ...
  template<typename U1, typename U2,
    enable_if_t<
      ...
      >::value,
    int> = 0>
  constexpr tuple(pair<U1, U2>&& p) : base(lsd::move(p.first), lsd::move(p.second)) {}
  ...
  template<typename U1, typename U2,
    enable_if_t<
      ...
      >::value,
    int> = 0>
  constexpr explicit tuple(pair<U1, U2>&& p) : base(lsd::move(p.first), lsd::move(p.second)) {}
  ...
  constexpr tuple(allocator_arg_t, const Alloc& alloc, pair<U1, U2>&& p)
      : base(allocator_arg_t{}, alloc, lsd::move(p.first), lsd::move(p.second)) {}
  ...
  constexpr tuple(allocator_arg_t, const Alloc& alloc, const tuple& other)
    ...
    static_assert(conjunction<is_copy_constructible<Types>...>::value,
                  "lsd::tuple(allocator_arg_t, const Alloc&, const tuple&) : All types must be copy constructible");
  }
  ...
  LSD_CONSTEXPR_AFTER_14 tuple& operator=(const tuple& other) = default;

//  LSD_CONSTEXPR_AFTER_14 tuple& operator=(const tuple& other) {
//    detail::tuple_element_wise_copy(*this, other, detail::make_tuple_sequence<tuple>{});
//    return *this;
//  }

//  LSD_CONSTEXPR_AFTER_14 tuple& operator=(tuple&& other) {
//    detail::tuple_element_wise_forward(*this, lsd::move(other), detail::make_tuple_sequence<tuple>{});
//    return *this;
//  }
...
template<typename T, typename... Types>
constexpr T&& get(tuple<Types...>&& t) noexcept {
  return lsd::move(static_cast<detail::tuple_leaf_by_type<T, tuple<Types...>>&&>(t.base).element);
}

template<typename T, typename... Types>
constexpr const T&& get(const tuple<Types...>&& t) noexcept {
  return lsd::move(static_cast<detail::tuple_leaf_by_type<T, tuple<Types...>>const &&>(t.base).element);
}
...
typename detail::make_tuple_type<Types...>::type make_tuple(Types&&... types) {
  ...
  return type(lsd::forward<Types>(types)...);
}
...
constexpr tuple<Types&&...> forward_as_tuple(Types&&... types) noexcept {
  return tuple<Types&&...>(lsd::forward<Types>(types)...);
}
...
constexpr R tuple_cat_impl(Tuple&& t, index_sequence<I1...>, index_sequence<I2...>) {
  return R(lsd::get<I2>(lsd::get<I1>(lsd::forward<Tuple>(t)))...);
}
...
typename detail::tuple_cat_type<Tuples...>::type tuple_cat(Tuples&&... args) {
  ...
  return detail::tuple_cat_impl<return_type>(
    lsd::forward_as_tuple(lsd::forward<Tuples>(args)...),
...
struct ignore_t {
  template<typename T>
  LSD_CONSTEXPR_AFTER_14 void operator=(T&&) const noexcept {}
};
 ...
 * ignore
 */
LSD_INLINE_VAR constexpr detail::ignore_t ignore;


namespace detail {

inline LSD_CONSTEXPR_AFTER_14 void dev_null(...) noexcept {}

template<typename Dst, typename Src, size_t... I>
LSD_CONSTEXPR_AFTER_14 void tuple_element_wise_copy(Dst& dst, const Src& src, index_sequence<I...>) {
  dev_null(((lsd::get<I>(dst) = lsd::get<I>(src)), 0)...);
}

template<typename Dst, typename Src, size_t... I>
LSD_CONSTEXPR_AFTER_14 void tuple_element_wise_forward(Dst& dst, Src&& src, index_sequence<I...>) {
  dev_null(((lsd::get<I>(dst) = lsd::get<I>(lsd::forward<Src>(src))), 0)...);
}
...
constexpr auto apply_impl(F&& f, Tuple&& t, index_sequence<I...>)
    -> decltype(lsd::invoke(lsd::forward<F>(f), lsd::get<I>(lsd::forward<Tuple>(t))...))
{
  return lsd::invoke(lsd::forward<F>(f), lsd::get<I>(lsd::forward<Tuple>(t))...);
}
...
constexpr auto apply(F&& f, Tuple&& t)
    -> decltype(detail::apply_impl(lsd::forward<F>(f), lsd::forward<Tuple>(t), detail::make_tuple_sequence<decay_t<Tuple>>{}))
{
  return detail::apply_impl(lsd::forward<F>(f), lsd::forward<Tuple>(t), detail::make_tuple_sequence<decay_t<Tuple>>{});
}
...
constexpr T make_from_tuple_impl(Tuple&& t, index_sequence<I...>) {
  return T(lsd::get<I>(lsd::forward<Tuple>(t))...);
}
} // namespace detail
...
constexpr T make_from_tuple(Tuple&& t) {
  return detail::make_from_tuple_impl<T>(lsd::forward<Tuple>(t), detail::make_tuple_sequence<decay_t<Tuple>>{});
}
