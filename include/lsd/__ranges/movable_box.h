...
struct movable_box_storage_base<T, true> {
  ...
  constexpr const T* operator->() const noexcept { return lsd::addressof(value_); }
  constexpr T* operator->() noexcept { return lsd::addressof(value_); }
