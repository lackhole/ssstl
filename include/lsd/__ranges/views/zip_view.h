...
class zip_view : public view_interface<zip_view<Views...>> {
 ...
 public:
  ...
  class iterator : public detail::zip_view_iterator_category<conjunction<forward_range<maybe_const<Const, Views>>...>::value> {
   ...
   public:
...
#if __cplusplus < 202002L
    using pointer = void;
    using reference = decltype(lsd::tuple_transform(
    ...
    constexpr decltype(auto) operator*() const {
      return lsd::tuple_transform(current_, [](auto& i) -> decltype(auto) { return *i; });
    }
    ...
    constexpr iterator& operator++() {
      lsd::tuple_for_each(current_, [](auto& i) { ++i; });
      return *this;
    }
    ...
    constexpr iterator& operator+=(difference_type n) {
      lsd::tuple_for_each(current_, [&](auto& i) {
        static_assert(std::is_lvalue_reference<decltype(i)>::value, "Invalid type");
        using I = remove_cvref_t<decltype(i)>;
  ...
  constexpr auto begin() {
    return iterator<false>(in_place, lsd::tuple_transform(views_, ranges::begin));
  }
  ...
  constexpr auto begin() const {
    return iterator<true>(in_place, lsd::tuple_transform(views_, ranges::begin));
  }
  ...
  constexpr auto size() {
    return lsd::apply(
        ...
        lsd::tuple_transform(views_, ranges::size)
    );
  }
 ...
 private:
  ...
  static constexpr auto end_impl(Self&& self, std::false_type /* zip_is_common */, Any) {
    return sentinel<Const>{in_place, lsd::tuple_transform(self.views_, ranges::end)};
  }
  ...
  static constexpr auto end_impl(Self&& self, std::true_type /* zip_is_common */, std::false_type /* random_access_range */) {
    return iterator<Const>(in_place, lsd::tuple_transform(self.views_, ranges::end));
  }
