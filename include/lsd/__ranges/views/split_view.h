 ...
 public:
  ...
  class iterator {
   public:
    ...
    LSD_CONSTEXPR_AFTER_CXX17 iterator(split_view& parent, iterator_t<V> current, subrange<iterator_t<V>> next)
        : parent_(lsd::addressof(parent)), cur_(std::move(current)), next_(std::move(next)), trailing_empty_(false) {}
