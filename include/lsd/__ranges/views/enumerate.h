...
LSD_INLINE_VARIABLE constexpr detail::enumerate_adaptor_closure<std::tuple> enumerate{};

LSD_INLINE_VARIABLE constexpr detail::enumerate_adaptor_closure<std::pair> enumerate_pair{};
