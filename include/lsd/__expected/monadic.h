 ...
 public:
  ...
  constexpr auto operator()(F&& f, Self&& self) const {
    if (self.has_value()) {
      ...
      return lsd::invoke(std::forward<F>(f), std::forward<Self>(self).error());
    }
  }
};
 ...
 public:
  ...
  constexpr auto operator()(F&& f, Self&& self) const {
    if (self.has_value()) {
      ...
      return Expected<T, G<F, Self>>(unexpect, lsd::invoke(std::forward<F>(f), std::forward<Self>(self).error()));
    }
  }
};
