...
int main() {
  ...
  { // test access
    ...
    SS_TEST_NOCATCH(b1.test(0))
    SS_TEST(b1.test(0) == 1)
    
    SS_TEST_CATCH(b1.test(1), std::out_of_range)
    SS_TEST_CATCH(b1.test(2), std::out_of_range)
    SS_TEST_CATCH(b1.test(3), std::out_of_range)
    SS_TEST_CATCH(b1.test(4), std::out_of_range)
  ...
  { // test string
    ...
    SS_TEST_CATCH(bit4(str, 99), std::out_of_range)
    
    SS_TEST_CATCH(bit4("abcd"), std::invalid_argument)
    SS_TEST_CATCH(bit4("000a"), std::invalid_argument)
    SS_TEST_CATCH(bit4("a000"), std::invalid_argument)
    SS_TEST_NOCATCH(bit4("0000a"))
  ...
  { // set, reset, flip
    ...
    SS_TEST_CATCH(b.set(99, false), std::out_of_range)
    ...
    SS_TEST_CATCH(b.reset(999), std::out_of_range)
    ...
    SS_TEST_CATCH(b.flip(9), std::out_of_range)
  }
  ...
  { // conversion
    ...
    b1.flip();
    SS_TEST_CATCH(b1.to_ulong(), std::overflow_error)

    ss::bitset<ullong_bit + 1> b2;
    SS_TEST(b2.to_ulong() == 0)
    b2.flip();
    SS_TEST_CATCH(b2.to_ulong(), std::overflow_error)
  }
