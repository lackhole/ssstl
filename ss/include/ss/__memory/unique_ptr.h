...
#ifndef SS___MEMORY_UNIQUE_PTR_H_
#define SS___MEMORY_UNIQUE_PTR_H_

#include "ss/compressed_pair.h"
#include "ss/functional.h"
#include "ss/__memory/default_delete.h"
...
template<typename CharT, typename Traits, typename Y, typename D,
    enable_if_t<
      is_same<
        ...
        decltype(ss::declval<basic_ostream<CharT, Traits>&>() << ss::declval<const unique_ptr<Y, D>&>().get())
      >::value,
    int> = 0>
...
#endif // SS___MEMORY_UNIQUE_PTR_H_
